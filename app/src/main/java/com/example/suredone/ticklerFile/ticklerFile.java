...
public class ticklerFile extends AppCompatActivity {
    ...
    public static void takeTaskToInbox(TicklerFileTask ticklerFileTask, DataBaseHelper dataBaseHelper){
    ...
    public static void takeActiveTasksToInbox(DataBaseHelper dataBaseHelperToTakeBackToInbox){
