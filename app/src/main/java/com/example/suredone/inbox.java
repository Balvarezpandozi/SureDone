...
import static com.example.suredone.ticklerFile.takeActiveTasksToInbox;
...
public class inbox extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataBaseHelper = new DataBaseHelper(inbox.this);
    ...
    private void showInboxTasksOnListView(DataBaseHelper dataBaseHelper1){
        inboxAdapter = new ArrayAdapter<InboxTask>(inbox.this, android.R.layout.simple_list_item_1, dataBaseHelper1.getAllInboxTasks());
